...
bot_token = "508436560:AAEL1sdrmifHWXRbOFfu8kzFdlyDFSh0f_c" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		khalseh = '/root/respina'
	elseif not server_user:match("^root$") then
		khalseh = '/home/'..server_user..'/respina'
	end
  ...
  config = {
    ...
    sudo_users = {477813517,362834029,328658415},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..khalseh..'/data/moderation.json'},
